...
highlight! WildMenu     guibg=#ffd787 guifg=fg gui=none ctermbg=black ctermfg=159 cterm=none
...
highlight! Constant     guibg=none guifg=#101010 gui=bold ctermbg=none ctermfg=233 cterm=italic " strings
